...
ecg_data = np.array(0)
data = {}
fs = 1000  # Frequency of hearty patch
...
class compute_heart_rate:
    ...
    def compute(self, df_input):
        ...
        qrs_frames_swt, rr_intervals_swt, hr_swt = \
            get_cardiac_infos(ecg_data, fs*2*1.09, "swt")  # Explain
...
if __name__ == "__main__":
    ...
    dataset_streamlit/Backup/df_full_ecg_data_merge_111001.pkl
